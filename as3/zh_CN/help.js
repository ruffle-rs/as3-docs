  ...
  if (cookiesNotEnabled())
  {
	...
	if (args[name] !== false) { 
		...
		if( typeof(localStorage) != 'undefined'){
    		var keyvalue = localStorage.getItem(name);
    		if(keyvalue != null){
    			return keyvalue;
    		}
    	}
...
function checkTheInputString2()		// double-byte version
{
	...
	searchTerm = searchTerm.replace(new RegExp(String.fromCharCode(12290),'g')," "); //replace locale dot
